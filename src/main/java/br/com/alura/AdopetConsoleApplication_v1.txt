...
public class AdopetConsoleApplication_v1 {
        ...
        try {
            ...
            while (opcaoEscolhida != 5) {
                ...
                if (opcaoEscolhida == 1) {
                    ...
                    // Extrair a função abaixo e criar o método listarAbrigo();
                    ...
                    // Extrair a função abaixo e criar o método cadastrarAbrigo();
                    ...
                    // Extrair a função abaixo e criar o método listarPetsDoAbrigo();
                    ...
                    // System.out.println(id +" - " +tipo +" - " +nome +" - " +raca +" - " +idade +"
                    // ano(s)");
                    // }
                } else if (opcaoEscolhida == 4) {

                    importarPetsDoAbrigo();
                    // Extrair a função abaixo e criar o método importarPetsDoAbrigo();
                    // System.out.println("Digite o id ou nome do abrigo:");
                    // String idOuNome = new Scanner(System.in).nextLine();
